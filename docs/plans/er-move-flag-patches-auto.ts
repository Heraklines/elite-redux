// Auto-generated by er-move-flags-audit. Reference data (not imported by the build).
import { MoveFlags } from "#enums/move-flags";

export const ER_MOVE_FLAG_PATCHES: ReadonlyArray<readonly [string, MoveFlags]> = [
