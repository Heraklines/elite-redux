...
| D — persistence and causal replay | FAILING | Focused successor76d5024fa passed native browser host14/14 on the default stack after isolating capsule import. Independent replay run35803370863 overflowed at3455 captured events/1728 segments in StarterSelect before wave1; a frame-split successor is running. | Complete contiguous campaign replay plus normal CLI/Wasm eventwise equality, storage uncertainty/conflict/retry and pending operation restoration. | root |
