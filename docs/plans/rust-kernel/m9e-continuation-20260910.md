...
All rows below refer to current source pin399d5d368f0b5642ebf8f45bd8a5e73350fa4de7 and the single current-phase integration branch. The remote command actually used is `python3 scripts/ci/m9e_current_phase_diagnostic.py`; it builds and executes exact whole targets. Additional named acceptance targets are required work, not claimed executions. Latest completed candidate086613d4a/run34702704401 passed compilation and15 whole targets/124 tests, but failed Clippy, three targets and the replay deadline; local successors remain unqualified. Earlier b66337a5d/run34700330243 evidence is retained separately and does not qualify the successor.
