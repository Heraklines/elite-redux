...
pub(super) fn execute(
    ...
    let applied = candidate.current_battle_participation.as_ref()
        ...
        .is_some_and(|reward| matches!(reward.stage,er_state::current_reward_selection::CurrentRewardStageV1::Applied { .. })
            || (matches!(reward.stage,er_state::current_reward_selection::CurrentRewardStageV1::TmPending { .. })
