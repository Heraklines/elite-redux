...
pub(super) fn transition(
    ...
    let GameOwnedPhaseV1::RewardBegin { pending, menu_instance } = &phase else {
        return Err(failure());
    };
    ...
    crate::current_reward_selection::install_control(&mut candidate, *pending,
        *menu_instance, safe_increment(revision)?, authority_seat)?;
    ...
    Ok(GameTransitionMaterialV6 {
        ...
        presentation: Vec::new(), rng_audit, platform_effects: Vec::new(),
    })
}
