...
const CURRENT_WILD_DOUBLE_ID: &str =
    "399d5d368f0b5642ebf8f45bd8a5e73350fa4de7:src/battle-scene.ts:2387";
...
impl RngCallsiteId {
    ...
    pub fn current_wild_double() -> Self {
        Self(CURRENT_WILD_DOUBLE_ID.to_owned())
    }
...
fn callsite_spec(value: &str) -> Option<(RngReason, u8)> {
    match value {
        ...
        CURRENT_WILD_DOUBLE_ID => Some((RngReason::RandomSelector, stream_bit(RngStream::Run))),
