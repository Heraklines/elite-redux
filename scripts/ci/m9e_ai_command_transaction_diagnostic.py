"""Remote F for atomic AI command preparation; integration remains separate."""
import hashlib
import json
import os
...
REPORT = Path(os.environ["RUNNER_TEMP"]) / "m9e-ai-command-transaction-focused"
FULL = REPORT / "diagnostics"
COMPACT = REPORT / "compact"
TARGET = REPORT / "target"
os.environ["CARGO_TARGET_DIR"] = str(TARGET)
DEADLINE = time.monotonic() + 1800
RUST_SOURCES = ["rust/crates/er-kernel/src/game_kernel_v7.rs", "rust/crates/er-kernel/tests/m9e_ai_command_transaction_v7.rs"]
TEST_TARGET = "m9e_ai_command_transaction_v7"
TEST_IDS = ["command_cursor_rejection_preserves_ai_sequence_and_all_other_owners",
...
def main(summary):
    ...
    sources = [*RUST_SOURCES, "rust/crates/er-kernel/src/game_kernel_v7.rs", "rust/crates/er-kernel/src/snapshot_v7.rs",
               ...
               "scripts/ci/m9e_current_cost.py", "scripts/ci/m9e_ai_command_transaction_diagnostic.py",
               ".github/workflows/m9e-ai-command-transaction-focused.yml",
    ...
    if listing != "".join(name + ": test\n" for name in TEST_IDS):
        raise RuntimeError("exact three-test inventory differs")
    ...
    if counts != [("3", "0", "0", "0", "0")]:
        raise RuntimeError("exact three-test completion differs")
    ...
    summary["tests"] = {"executed": 3, "passed": 3, "failed": 0, "skipped": 0}
