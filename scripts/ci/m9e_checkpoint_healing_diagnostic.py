...
REPORT = Path(os.environ["RUNNER_TEMP"]) / "m9e-checkpoint-healing-focused"
FULL = REPORT / "diagnostics"
COMPACT = REPORT / "compact"
TARGET = REPORT / "target"
os.environ["CARGO_TARGET_DIR"] = str(TARGET)
DEADLINE = time.monotonic() + 1800
RUST_SOURCES = ["rust/crates/er-kernel/src/game_kernel_v7.rs", "rust/crates/er-kernel/tests/m9e_checkpoint_healing_v7.rs",
                "rust/crates/er-game/src/m9e_runtime_v6.rs", "rust/crates/er-progression/src/progression.rs", "rust/crates/er-game/src/m9e_new_run_v6.rs"]
TEST_TARGET = "m9e_checkpoint_healing_v7"
TEST_IDS = ["ordinary_wave_reward_preserves_damage_status_and_used_pp", "raw_checkpoint_reward_restores_party_and_replays_from_snapshot"]
sequence = 0
logs = {}
failed_log = None
...
def main(summary):
    ...
    sources = [*RUST_SOURCES, "rust/crates/er-kernel/src/game_kernel_v7.rs", "rust/crates/er-kernel/src/snapshot_v7.rs",
               ...
               "scripts/ci/m9e_current_cost.py", "scripts/ci/m9e_checkpoint_healing_diagnostic.py",
               ".github/workflows/m9e-checkpoint-healing-focused.yml",
...
if __name__ == "__main__":
    ...
    summary = {"status": "failed", "qualification": "constructed default checkpoint HP/status/PP boundary only; no full campaign or M9 qualification",
