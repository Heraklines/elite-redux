...
if __name__ == "__main__":
    ...
    summary = {"status": "failed", "qualification": "bounded owned proposal retirement compatibility: unchanged 39 current co-op, admission, snapshot and retention tests; full campaign is separate",
               "source_sha": os.environ["GITHUB_SHA"], "run_id": os.environ["GITHUB_RUN_ID"],
               "run_attempt": os.environ["GITHUB_RUN_ATTEMPT"], "base_sha": "d8a8b99b4af3514181b3b8f087a4b114c28f98ee"}
    try:
        main(summary)
        if TARGET.exists():
