...
def main(summary):
    ...
    changes = run(["git", "diff", "--name-only", "3b4ce13303bbfb05f2038931a5298bc090f1374c", "HEAD"], "source-delta", 30, 16384).read_text().splitlines()
    ...
    summary["base_sha"] = "3b4ce13303bbfb05f2038931a5298bc090f1374c"
