...
def main():
    ...
    try:
        ...
        require(result["targets_attempted"] == 19, "every whole target must be attempted")
        ...
        require(result["tests_executed"] == 83, "all58 inherited tests plus4 coop,3 phase,1 progression,1 campaign,1 coop-campaign,1 replay,2 retained KO source tests and12 whole-library tests")
