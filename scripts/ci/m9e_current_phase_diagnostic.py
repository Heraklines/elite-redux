...
def main():
    ...
    try:
        ...
        require(result["targets_attempted"] == 22, "every short whole target must be attempted")
        ...
        require(result["tests_executed"] == 162, "all162 exact short tests across22 complete target inventories")
