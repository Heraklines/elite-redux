...
def main():
    ...
    try:
        ...
        require(result["tests_executed"] == 81, "all58 inherited tests plus4 coop,1 phase,1 progression,1 campaign,1 coop-campaign,1 replay,2 retained KO source tests and12 whole-library tests")
