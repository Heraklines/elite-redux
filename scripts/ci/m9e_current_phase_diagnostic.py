...
def main():
    ...
    try:
        ...
        require(result["tests_executed"] == 128, "all83 predecessor tests plus1 Flash phase,2 source constructor,14 whole state-library,14 whole browser-host and3 source reward arithmetic tests plus5 whole menu-type and6 whole menu-validation tests")
