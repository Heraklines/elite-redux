...
def main():
    ...
    try:
        ...
        require(result["tests_executed"] == 163, "all83 predecessor tests plus1 Flash phase,2 source constructor,49 whole state-library,14 whole browser-host and3 source reward arithmetic tests plus5 whole menu-type and6 whole menu-validation tests")
