...
def main():
    ...
    try:
        ...
        run("proposal-clippy", ["cargo", "clippy", "--locked", "--keep-going", "-p", "er-types", "-p", "er-battle", "-p", "er-state", "-p", "er-game", "-p", "er-kernel", "-p", "er-save", "-p", "er-env", "-p", "er-cli", "-p", "er-progression", "-p", "er-repro", "-p", "er-web", "--tests", "--no-deps", "--", "-D", "warnings"], ROOT/"rust")
        ...
        require(result["tests_executed"] == 127, "all83 predecessor tests plus1 Flash phase,1 source constructor,14 whole state-library,14 whole browser-host and3 source reward arithmetic tests plus5 whole menu-type and6 whole menu-validation tests")
