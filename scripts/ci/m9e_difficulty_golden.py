"""Remote whole-target qualification of the audited run-difficulty report change."""
import hashlib
import json
import os
...
REPORT = Path(os.environ["RUNNER_TEMP"]) / "m9e-difficulty-golden"
FULL, COMPACT = REPORT / "diagnostics", REPORT / "compact"
STARTED_AT = None
DEADLINE = None
run_bounded = None
BASE = "0b211cfbf0730d8228b6b16656b8c94fa3000790"
...
COHORTS = {
    ...
    "new": {"commit": "24beac2761fec35131380ba4b64fc5bd2cf4129d", "bytes": 16325821,
            ...
            "report_digest": "e426cc7e5fef4bf23b2f081d5d0f3fe44b4ceb33046982638a620e1f6cd9276b"},
}
...
def main(summary):
    ...
    if (len(exact_test) != 29501 or hashlib.sha256(exact_test).hexdigest()
            != "625fdc6fd7ee0e8ef45bde564f4aa584b4edbb390ad0d1bd557509bdc7a5d750"):
        raise RuntimeError("only the audited current cohort golden may differ")
    original = exact_test.replace(b"e426cc7e5fef4bf23b2f081d5d0f3fe44b4ceb33046982638a620e1f6cd9276b",
                                 b"c28ac3b994c687413a4d0bcae7c558f0e02dfafd5e9ec3482bbb9462f5598063")
    if hashlib.sha256(original).hexdigest() != "95c09508d4ac63e3a401d2abd1a14725de8d85b1d5405f4de9d0e1999032ee6c":
        raise RuntimeError("original complete parity assertions must remain exact")
...
if __name__ == "__main__":
    ...
    summary = {"status": "failed", "source_sha": os.environ["GITHUB_SHA"], "run_id": os.environ["GITHUB_RUN_ID"],
               ...
               "preimage_diagnostic": {"source_sha": "cd8123eb122111c2cf67f0e0a6b5d15b718cf27b", "run_id": "34258518883",
                   "summary_sha256": "7ed60527cfad14664c8cbdbc5d63e07c114d0a4f9d3ccbe57f2de7080ca6a349",
                   "actual_events": 30, "decoded_materials_per_cohort": 6, "difference_paths": 28, "omitted_paths": 0},
