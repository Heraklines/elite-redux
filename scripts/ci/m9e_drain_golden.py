"""Remote whole-target qualification of the audited published-drain content report change."""
import hashlib
import json
import os
...
REPORT = Path(os.environ["RUNNER_TEMP"]) / "m9e-drain-golden"
...
COHORTS = {
    ...
    "new": {"commit": "32a5c987c9767c9c6e87ff57e2bce6dced0ffb46", "bytes": 16335369,
            "git_blob": "cabb11ce9bc146b3a615bf334d5342d7b67528da",
            "sha256": "a42bf206c6e9a848df5774e58c1f0190f562ceefb90f4dc07e97125eaf0ae6af",
            "bundle_hash": "blake3-v1:4e11aa7e6ef4f5c0bc39e4a29ab0b28a512f5cdefa4e5bdd2fc9aab20e2c815a",
            "progression_hash": "b167ad856885c95dab4f1e9cdf1456dd4924f6c4dbc8443e12918f232215192e",
            "report_digest": "658cd9b848fb230ddd21df241162a97f47d98a37420a06126bf88edbb6380c89"},
}
...
SOURCES = [TEST_SOURCE, "rust/crates/er-game/src/m9e_material_v6.rs", "rust/crates/er-wasm/src/m9e_parity.rs", "rust/crates/er-wasm/src/lib.rs",
           ...
           "scripts/ci/m9e_drain_golden.py", ".github/workflows/m9e-drain-golden-focused.yml"]
DRAIN_CONSTANT = r'''const DRAIN_METADATA_PARITY: (&str, &str, usize, &str) = (
...
if __name__ == "__main__":
    ...
    summary = {"status": "failed", "source_sha": os.environ["GITHUB_SHA"], "run_id": os.environ["GITHUB_RUN_ID"],
               ...
               "preimage_diagnostic": {"source_sha": "79ddc7c34873527d99a451aa93d72cfb2fd4aea2", "run_id": "34263953100",
                   "summary_sha256": "c921c43a3bfaffe0f4c966fd38aa3e27d0b782f111dc835f2b858583b0df38e6",
