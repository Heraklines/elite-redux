...
OWNED_FOUNDATION_INVENTORY_SHA256 = "a2c79478cfd77bf214fed5f8ef4c4672e112b913bd119e4ad3837d050c65711b"
...
def owned_foundation_inventory():
    ...
    expected = {"schema_version": 2, "prior_tests": 759, "prior_targets": 98, "tests": 842, "targets": 113}
    ...
    if len(rows) != 113 or sum(len(row["ids"]) for row in rows) != 842:
...
def validate_owned_foundation_inventory(plan, inventory):
    ...
    if plan.get("current_recovery_integration"):
        if (plan.get("owned_foundation_inventory_sha256") != OWNED_FOUNDATION_INVENTORY_SHA256
            ...
            raise RuntimeError("owned foundation complete842/113 inventory differs")
