...
OWNED_FOUNDATION_INVENTORY_SHA256 = "588978f2405d16ccf3c0b05538499f419cfffc93b30d4efadf346c1faaf3b9b5"
...
def owned_foundation_inventory():
    ...
    expected = {"schema_version": 2, "prior_tests": 759, "prior_targets": 98, "tests": 824, "targets": 109}
    ...
    if len(rows) != 109 or sum(len(row["ids"]) for row in rows) != 824:
...
def validate_owned_foundation_inventory(plan, inventory):
    ...
    if plan.get("current_recovery_integration"):
        if (plan.get("owned_foundation_inventory_sha256") != OWNED_FOUNDATION_INVENTORY_SHA256
            ...
            raise RuntimeError("owned foundation complete824/109 inventory differs")
