...
OWNED_FOUNDATION_INVENTORY_SHA256 = "884eb7fcfc97eadc236e2b8592889d0eb6ca28ba6e760bf1a1f97e4dee878bf3"
...
def owned_foundation_inventory():
    ...
    expected = {"schema_version": 2, "prior_tests": 759, "prior_targets": 98, "tests": 854, "targets": 115}
    ...
    if len(rows) != 115 or sum(len(row["ids"]) for row in rows) != 854:
...
def validate_owned_foundation_inventory(plan, inventory):
    ...
    if plan.get("current_recovery_integration"):
        if (plan.get("owned_foundation_inventory_sha256") != OWNED_FOUNDATION_INVENTORY_SHA256
            ...
            raise RuntimeError("owned foundation complete854/115 inventory differs")
