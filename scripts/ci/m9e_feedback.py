...
RUST = ROOT / "rust"
TIMINGS = {}
WORKER_BOUND_TARGETS = {("er-cli", "m9e_current_coop_rebind"), ("er-lab", "current_worker_rebind_v2"), ("er-lab", "current_kernel_endpoint_v2"),
...
RECOVERY_DEV_EDGES = {"er-progression": {"sha2": {"workspace": True}},
                      "er-repro": {"er-battle": {"path": "../er-battle"}, "er-state": {"path": "../er-state"}, "er-protocol": {"path": "../er-protocol"}}, "er-lab": {"er-protocol": {"path": "../er-protocol"}}}


def recovery_dependency_guard(before_manifests, after_manifests, before_lock, after_lock):
    """Admit only the five reviewed test dependencies and their existing lock edges."""
...
COOP_RECEIPT_IDS = ["natural_cooperative_lost_reply_restores_retries_and_continues_without_reexecution", "natural_cooperative_public_retry_restores_pending_publication_and_continues", "owned_reply_raw_admission_replaces_capacity_one_and_rejects_forged_snapshots"]
...
OWNED_FOUNDATION_PATHS = ["rust/crates/er-content-compiler/tests/m9e_full_content.rs","rust/crates/er-kernel/tests/m9e_current_proposal_v7.rs","rust/crates/er-battle/src/m7_resolver.rs","rust/crates/er-game/src/m9e_content_v2.rs","rust/crates/er-game/src/m9e_material_v6.rs","rust/crates/er-game/src/m9e_new_run_v6.rs","rust/crates/er-game/src/m9e_runtime_v6.rs","rust/crates/er-game/tests/m9e_battle_participation.rs","rust/crates/er-game/tests/m9e_content_v2.rs","rust/crates/er-game/tests/m9e_material_retention.rs","rust/crates/er-game/tests/m9e_material_v6.rs","rust/crates/er-game/tests/m9e_runtime_v6.rs","rust/crates/er-kernel/tests/m9e_material_retention_v7.rs","rust/crates/er-kernel/tests/m9e_snapshot_v7.rs","rust/crates/er-progression/src/content_v2.rs","rust/crates/er-progression/tests/m9e_content_v2.rs","rust/crates/er-save/src/m9e_save_v2.rs","rust/crates/er-state/src/current_battle_participation.rs","rust/crates/er-state/src/current_experience_owner.rs","rust/crates/er-state/src/lib.rs","rust/crates/er-state/src/m9e_state_v6.rs","rust/crates/er-progression/src/lib.rs","rust/crates/er-progression/src/current_friendship.rs","rust/crates/er-progression/tests/m9e_current_friendship.rs","rust/crates/er-kernel/src/current_coop_rebind_v7.rs","rust/crates/er-kernel/src/current_coop_setup_v7.rs","rust/crates/er-kernel/src/current_proposal_v7.rs","rust/crates/er-kernel/src/game_kernel_v7.rs","rust/crates/er-kernel/tests/m9e_current_coop_rebind_v7.rs","rust/Cargo.lock","rust/crates/er-agent-protocol/src/lib.rs","rust/crates/er-cli/src/current_agent.rs","rust/crates/er-cli/src/current_native_capture.rs","rust/crates/er-cli/tests/m9e_current_coop_rebind.rs","rust/crates/er-cli/tests/support/m9e_coop_cli_process.rs","rust/crates/er-env/src/current.rs","rust/crates/er-kernel-worker/src/protocol_v2.rs","rust/crates/er-kernel-worker/src/runtime_v2.rs","rust/crates/er-lab/Cargo.toml","rust/crates/er-lab/src/kernel_reload/endpoint_v2.rs","rust/crates/er-lab/src/kernel_reload/supervisor_v2.rs","rust/crates/er-lab/src/kernel_reload/types_v2.rs","rust/crates/er-lab/tests/current_worker_rebind_v2.rs","rust/crates/er-progression/src/current_friendship_owner.rs","rust/crates/er-progression/tests/m9e_owned_friendship.rs","rust/crates/er-repro/Cargo.toml","rust/crates/er-repro/src/current.rs","rust/crates/er-repro/tests/m9e_current_rebind_repro.rs","rust/crates/er-web/src/contracts_v2.rs","rust/crates/er-web/src/host_v2.rs","rust/crates/er-web/src/host_v2/rebind_transaction_tests.rs","src/rust-browser/contracts/browser-contracts-v2.ts","src/rust-browser/host/current-rust-browser-host.ts","test/browser/rust-browser/m9e-v7-rebind.spec.ts","test/browser/rust-browser/m9e-v7-worker.spec.ts","test/node/rust-browser/engineering/current-worker-codec.test.ts","rust/crates/er-game/tests/m9e_damage_query.rs","rust/crates/er-cli/tests/support/m9e_current_state_query.rs","rust/crates/er-game/tests/m9e_run_difficulty.rs","rust/crates/er-kernel/tests/m9e_game_kernel_v7.rs","rust/crates/er-kernel/tests/m9e_title_storage.rs","rust/crates/er-battle/src/m6/routine_executor.rs","rust/crates/er-content-compiler/src/lib.rs","rust/crates/er-content-compiler/src/m9e_full_content.rs","rust/crates/er-content-compiler/src/m9e_move_drains.rs","rust/crates/er-game/tests/m9e_move_drains.rs","rust/crates/er-content-compiler/src/m9e_move_recoil.rs","rust/crates/er-game/tests/m9e_move_recoil.rs","rust/crates/er-ai/src/lib.rs","rust/crates/er-ai/src/m9e_standard_attack_score.rs","rust/crates/er-ai/tests/m9e_standard_attack_score.rs","rust/crates/er-game/src/lib.rs","rust/crates/er-game/src/m9e_ai_score_query.rs","src/rust-browser/adapters/current-rtc-transport-v2.ts","src/rust-browser/routes/rust-current-rtc-rebind-entry.ts","test/browser/rust-browser/m9e-v7-rebind-rtc.spec.ts","test/browser/rust-browser/m9e-v7-rebind-rtc-transport.spec.ts","test/browser/rust-browser/m9e-v7-rebind-rtc-owner.spec.ts","src/rust-browser/routes/rust-current-rtc-entry.ts","rust/crates/er-progression/src/current_party_experience.rs","rust/crates/er-progression/tests/m9e_party_experience.rs","rust/crates/er-progression/src/current_phase_experience.rs","rust/crates/er-progression/tests/m9e_phase_experience.rs","rust/crates/er-progression/tests/m9e_held_experience.rs","rust/crates/er-progression/src/current_phase_tree.rs","rust/crates/er-state/src/current_phase_tree.rs","rust/crates/er-progression/tests/m9e_phase_tree.rs","rust/crates/er-progression/tests/m9e_phase_tree_queries.rs","rust/crates/er-ai/src/party_snapshots.rs","rust/crates/er-game/src/m9_new_run.rs","rust/crates/er-scenario/src/party_requirements.rs","rust/crates/er-scenario/src/training_session.rs","rust/crates/er-state/src/m7_state.rs","rust/crates/er-testkit/tests/m7_system_proof.rs","rust/crates/er-battle/src/current_move_targets.rs","rust/crates/er-battle/src/lib.rs","rust/crates/er-battle/tests/m9e_current_move_targets.rs"]
OWNED_FOUNDATION_SOURCES = {"rust/crates/er-content-compiler/tests/m9e_full_content.rs":["7304b759dc346a9623d9df35c146087d27ef9f2d","b54173ccc7de4d467e3a91f437e03d859eea7c3d1bcd354566c9272c739291bf"],"rust/crates/er-kernel/tests/m9e_current_proposal_v7.rs":["936253818ce219f22b5bfbff1b851723f40f6163","0e8c3d8aa0e6083ccedb9529f797cedcda3dd8a163ca8f46310d484b1a497646"],
9e_held_experience.rs":["0582516a8aac2132ce00a49876ca622c60b452e5","326e8f2489286d237b3b80b6372e2734024de33eae58af58adaedf6677c205ef"],"rust/crates/er-progression/src/current_phase_tree.rs":["08043459eb978e93ad85719faff13181e785337d","e365c290dde63105319be47dda53afd22ebbc6259324c2579381a113956981ee"],"rust/crates/er-state/src/current_phase_tree.rs":["08043459eb978e93ad85719faff13181e785337d","7432e32ef6b2f3ebbe77b3187f295779934d171791de05bc41290a37a6797950"],"rust/crates/er-progression/tests/m9e_phase_tree.rs":["08043459eb978e93ad85719faff13181e785337d","1c0ca74f47d47ffec8c6e5f1d7d9c5a253fc3941947e2c9744b261d94ee02ac6"],"rust/crates/er-progression/tests/m9e_phase_tree_queries.rs":["08043459eb978e93ad85719faff13181e785337d","541bbb543e77eda63d087ec2d3fc7f8f4b0ec0fb0cc884a9ec4a6d464a2f84de"],"rust/crates/er-ai/src/party_snapshots.rs":["28f4156f3b05f04de99105e711307ae8bef4c415","726684368f6ca8700f0bd490b9c6646b577796cf7cfc8ac104c48ccff57fa057"],"rust/crates/er-game/src/m9_new_run.rs":["28f4156f3b05f04de99105e711307ae8bef4c415","a7735adfa50ccb22acbd8a8e4d4ad1837ce38e9ee1480a4044261e6c98d75a60"],"rust/crates/er-scenario/src/party_requirements.rs":["28f4156f3b05f04de99105e711307ae8bef4c415","f934ed4ca9d6c795861153962e5260b962bbf45f06ce8af896cc5e43de2751d9"],"rust/crates/er-scenario/src/training_session.rs":["28f4156f3b05f04de99105e711307ae8bef4c415","0abbdc41aaf29d0a65eb3f95ca9c5f050e1eb1ebd3ac1bf31c8ac56ac50ef335"],"rust/crates/er-state/src/m7_state.rs":["28f4156f3b05f04de99105e711307ae8bef4c415","ad81d248a296b3f584388df5509cc5c45f31533b78fc29007b09bb053fa70f33"],"rust/crates/er-testkit/tests/m7_system_proof.rs":["28f4156f3b05f04de99105e711307ae8bef4c415","70cf678f079f019fb050338f57284e1b3831bf1fd14260f8067c7695f3c00f26"],"rust/crates/er-battle/src/current_move_targets.rs":["232f3e21065ec92087f8eb945673cbc2cf9a1de1","77b3268c5449e4cc8d35c7aff3fc316f46526ce17935429370d9e7cc5e00f2b6"],"rust/crates/er-battle/src/lib.rs":["232f3e21065ec92087f8eb945673cbc2cf9a1de1","e3b035c6ee1fa52237dc64945d0e42f897d0118e0479a769190c81164c77ed75"],"rust/crates/er-battle/tests/m9e_current_move_targets.rs":["232f3e21065ec92087f8eb945673cbc2cf9a1de1","8f36bad43867a12018e8dfe4df3895b557460c1647afb7b5de841abc8f1bcc68"]}
OWNED_FOUNDATION_TEST_IDS = {"er-game:m9e_battle_participation":["current_faint_membership_uses_stable_ids_and_removes_player_after_recording","historical_owner_absence_preserves_canonical_bytes","malformed_evidence_capacity_and_counter_failures_roll_back","natural_bootstrap_switch_and_ko_preserve_legacy_gameplay","natural_enemy_faint_owns_unresolved_experience_without_applying_amount","next_natural_battle_retains_occurrence_highwater","observed_save_snapshot_and_material_replay_preserve_ownership","pending_experience_counter_exhaustion_rolls_back_real_enemy_faint","pending_experience_rejects_pokerus_changes_and_unknown_substitution","pending_experience_restore_rejects_source_policy_and_frontier_forgeries","pending_experience_survives_real_save_replay_and_rejects_owner_stripping_material","pending_experience_unsettled_tail_rejects_actions_and_next_encounter","selected_pokerus_preserves_all_other_natural_state_and_distinguishes_unknown","selected_pokerus_reaches_pending_experience_and_survives_real_save_replay","selected_pokerus_rejects_missing_reordered_and_mismatched_whole_selections"],"er-progression:m9e_current_friendship":["binary64_fusion_and_starter_cap_order_match_source_cases","boosted_caps_and_max_friendship_preserve_full_candy_progress","candy_saturation_zero_rate_egg_and_negative_requests_match_source","invalid_resolution_and_late_arithmetic_leave_inputs_unchanged","negative_and_zero_friendship_short_circuit_without_resolution","shared_fusion_progress_and_candy_roots_update_in_source_order"],"er-kernel:m9e_current_coop_rebind_v7":["equal_frontier_native_rebind_commits_two_atomically_without_gameplay","every_rebind_phase_restores_and_retries_exact_control_without_advancing_replay","malformed_rebind_controls_and_generation_bypasses_preserve_full_snapshot","open_rebind_executes_actual_owned_gameplay_and_retries_strict_v2_receipt","open_rebind_receipt_and_owner_mutations_reject_with_complete_state_conservation","open_rebind_replaces_original_v1_reply_atomically_at_capacity_one","rebind_begin_and_replay_exhaustion_reject_without_retiring_existing_owners","rebind_restore_checks_decision_binding_and_preserves_unrelated_scheduler_pause"],"er-repro:m9e_current_rebind_repro":["deleted_reordered_or_forged_rebind_attempts_fail_replay","natural_rebind_controls_and_generation_two_gameplay_replay_exactly","rebind_response_admission_and_rejections_preserve_complete_session"],"er-cli:m9e_current_coop_rebind":["actual_native_cli_rebind_preserves_capture_admission_restore_and_gameplay"],"er-lab:current_worker_rebind_v2":["midphase_rebind_tail_reloads_and_explicit_gaps_expire_old_tickets","natural_owned_workers_rebind_and_continue_generation_two_gameplay","rebind_result_budget_rejection_preserves_worker_state_and_frontier"],"er-progression:m9e_owned_friendship":["actual_fifteen_friendship_observations_compose_with_owned_rewards","owned_friendship_frontier_and_arithmetic_failures_preserve_pending","owned_friendship_tokens_reject_foreign_and_wrong_phase_without_mutation","owned_reward_admission_rejects_unsupported_context_and_keys","owned_reward_duplicate_settlement_and_finish_emit_no_new_effects","owned_reward_projection_keeps_unrelated_accounts_and_source_argument_identity"],"er-web:er_web":["host_v2::rebind_transaction_tests::browser_rebind_duplicates_noops_and_wrong_generation_keep_capture_exact","host_v2::rebind_transaction_tests::browser_rebind_natural_controls_and_generation_two_gameplay_replay","host_v2::rebind_transaction_tests::browser_rebind_receive_response_and_cache_rejection_preserve_transaction","host_v2::rebind_transaction_tests::browser_rebind_wire_decoding_rejects_unknown_control_fields","host_v2::transaction_tests::late_response_limit_rejection_preserves_state_cache_and_retry","host_v2::transaction_tests::read_only_response_limit_failure_preserves_capture","host_v2::transaction_tests::retained_response_byte_boundary_evicts_by_acceptance_and_preserves_retry","host_v2::transaction_tests::sequence_exhaustion_preflight_preserves_current_session_and_cached_response","host_v2::transaction_tests::single_response_cache_boundary_rejects_before_commit_and_disposal_clears_payloads"],"er-game:m9e_damage_query":["current_damage_queries_preserve_full_turn_and_rng_audit_after_reordering","current_damage_query_distinguishes_equal_power_by_physical_and_special_bulk","current_damage_query_honors_pp_up_and_override_bounds_without_mutation","current_damage_query_zero_and_inactive_inputs_leave_state_unchanged","current_immune_turn_preserves_hp_and_skips_only_damage_variance","current_immunity_queries_preserve_zero_minimum_damage_and_typeless_struggle","current_ordinary_ai_score_queries_preserve_full_turn_and_rng_audit","current_ordinary_ai_score_uses_actual_damage_bulk_and_knockout_boundary"],"er-kernel:m9e_game_kernel_v7":["authority_ai_can_choose_a_legal_enemy_switch","authority_ai_exhausted_max_pp_uses_struggle_without_extra_decisions_or_pp","authority_ai_max_pp_boundaries_drive_raw_choices_without_extra_rng","final_wave_victory_terminates_the_run","gamepad_buttons_drive_bootstrap_and_active_controls","held_action_cannot_cross_bootstrap_menu_instance","natural_solo_battle_reaches_terminal_using_only_physical_keys","nonterminal_battle_progresses_to_next_wave","raw_keys_complete_natural_start_and_install_serialized_v6_state","read_preserves_saved_difficulty_over_other_naturally_selected_live_difficulty","read_rebind_clears_real_repeat_ownership_without_cancelling_unrelated_work","read_rebind_keeps_larger_saved_floors_and_no_active_run_behavior","read_rebind_preserves_saved_semantics_and_executes_write_after_restore","read_rebind_rejects_stale_action_context_and_preserves_canonical_battle_root","read_rebind_rolls_back_menu_revision_presentation_and_replay_exhaustion"],"er-game:m9e_run_difficulty":["historical_absence_remains_unknown_and_canonical_on_save_restore","malformed_completed_selection_and_wrong_run_ownership_are_rejected","natural_choices_survive_material_save_restore_and_continued_dispatch","same_run_material_cannot_change_erase_or_invent_difficulty"],"er-game:m9e_move_drains":["actual_drain_minimum_one_and_maximum_hp_are_preserved","actual_drain_uses_capped_hp_loss_and_source_fraction","full_health_drain_does_not_emit_spurious_actor_hp_changes","immune_drain_neither_heals_nor_consumes_damage_variance","source_compiler_admits_twelve_unconditional_drains_and_preserves_other_units"],"er-game:m9e_move_recoil":["actual_recoil_minimum_one_and_actor_faint_are_preserved","actual_recoil_uses_capped_hp_loss_and_source_fraction","immune_recoil_neither_hurts_nor_consumes_damage_variance","recoil_damage_queries_preserve_actual_turn_and_borrowed_state","source_compiler_admits_six_exact_recoils_and_preserves_all_prior_units"],"er-ai:m9e_standard_attack_score":["all_remote_pinned_javascript_cases_match_binary64_bits","damage_not_base_power_controls_non_knockout_ranking","knockout_bonus_uses_raw_damage_and_weights_accuracy","zero_damage_and_always_hit_preserve_source_boundaries"],"er-progression:m9e_party_experience":["actual_pinned_source_matrix_matches_every_phase_binary64_argument","balance_redistributes_without_share_and_preserves_fractional_phase_arguments","invalid_input_and_overflow_do_not_produce_a_partial_plan","living_at_cap_friendship_and_full_participant_denominator_preserve_source_order"],"er-progression:m9e_phase_experience":["field_product_and_bench_ability_follow_distinct_source_paths","global_boosters_floor_each_application_and_preserve_order","invalid_context_and_unsafe_arithmetic_fail_without_an_award","whole_actual_phase_matrix_matches_every_add_exp_argument"],"er-progression:m9e_held_experience":["actual_whole_source_held_matrix_matches_every_fractional_phase_argument","explicit_empty_held_context_preserves_unboosted_source_behavior","held_booster_receives_fractional_product_before_distribution_floor","malformed_held_context_and_unsafe_awards_are_rejected_atomically"],"er-progression:m9e_phase_tree":["descendant_level_up_tasks_precede_barrier_and_recipient_siblings","every_actual_source_trace_and_intermediate_snapshot_matches","malformed_restore_and_excess_capacity_leave_queue_unchanged","source_clear_preserves_deferred_flag_and_retains_only_deepest_level"],"er-progression:m9e_phase_tree_queries":["find_and_exists_preserve_opposite_source_search_orders","insertion_and_removal_choose_first_deepest_match_and_source_fallback","query_admission_bounds_and_unknown_snapshot_fields_fail_closed","whole_source_queries_match_results_predicate_visits_and_restored_state"],"er-battle:m9e_current_move_targets":["invalid_owner_context_fails_without_inventing_rng_or_callback_results","source_random_draw_precedes_alive_filter_and_other_never_falls_back_to_ally","source_spread_promotion_keeps_adjacency_and_multihit_exception","whole_source_targeting_matches_all_twenty_categories_and_owner_call_order"]}
OWNED_EXISTING_TARGET_ADDITIONS = {"er-web:er_web":["host_v2::rebind_transaction_tests::browser_rebind_duplicates_noops_and_wrong_generation_keep_capture_exact","host_v2::rebind_transaction_tests::browser_rebind_natural_controls_and_generation_two_gameplay_replay","host_v2::rebind_transaction_tests::browser_rebind_receive_response_and_cache_rejection_preserve_transaction","host_v2::rebind_transaction_tests::browser_rebind_wire_decoding_rejects_unknown_control_fields"],"er-game:m9e_damage_query":["current_immune_turn_preserves_hp_and_skips_only_damage_variance","current_immunity_queries_preserve_zero_minimum_damage_and_typeless_struggle"],"er-kernel:m9e_game_kernel_v7":["read_preserves_saved_difficulty_over_other_naturally_selected_live_difficulty"]}
OWNED_FOUNDATION_INVENTORY = "scripts/ci/m9e-owned-foundations-inventory.json"
OWNED_FOUNDATION_INVENTORY_SHA256 = "b6f616cc569c2a189a170ecbd851aa502a973e1ab23be325ccc74f3a10df68cd"

RECOVERY_PATHS = [*["rust/crates/er-battle/src/m6/routine_executor.rs","rust/crates/er-content-compiler/src/lib.rs","rust/crates/er-content-compiler/src/m9e_full_content.rs","rust/crates/er-content-compiler/src/m9e_move_drains.rs","rust/crates/er-game/tests/m9e_move_drains.rs","rust/crates/er-content-compiler/src/m9e_move_recoil.rs","rust/crates/er-game/tests/m9e_move_recoil.rs"], *AI_COMMAND_PATHS, "rust/crates/er-game/src/m9e_runtime_v6.rs",
                  ...
                  "rust/crates/er-cli/tests/m9e_current_rulechange_reload.rs", *CHECKPOINT_PATHS, CANONICAL_PATH, *STRUGGLE_PATHS, *CAMPAIGN_PATHS, "rust/crates/er-kernel/tests/m9e_coop_choices_v7.rs", *RNG_PATHS, COOP_CAMPAIGN_PATH, COOP_RECEIPT_PATH, "rust/crates/er-kernel/src/current_coop_setup_v7.rs", *XP_PATHS, *["rust/crates/er-game/src/m9e_content_v2.rs","rust/crates/er-game/src/m9e_material_v6.rs","rust/crates/er-game/tests/m9e_battle_participation.rs","rust/crates/er-game/tests/m9e_content_v2.rs","rust/crates/er-game/tests/m9e_material_retention.rs","rust/crates/er-game/tests/m9e_material_v6.rs","rust/crates/er-game/tests/m9e_runtime_v6.rs","rust/crates/er-kernel/src/current_coop_rebind_v7.rs","rust/crates/er-kernel/src/current_proposal_v7.rs","rust/crates/er-kernel/tests/m9e_current_coop_rebind_v7.rs","rust/crates/er-kernel/tests/m9e_material_retention_v7.rs","rust/crates/er-kernel/tests/m9e_snapshot_v7.rs","rust/crates/er-progression/src/current_friendship.rs","rust/crates/er-progression/tests/m9e_current_friendship.rs","rust/crates/er-save/src/m9e_save_v2.rs","rust/crates/er-state/src/current_battle_participation.rs","rust/crates/er-state/src/current_experience_owner.rs","rust/crates/er-state/src/lib.rs","rust/crates/er-state/src/m9e_state_v6.rs"], "rust/crates/er-kernel/tests/m9e_current_proposal_v7.rs"]
RECOVERY_PATHS += ["rust/crates/er-agent-protocol/src/lib.rs","rust/crates/er-cli/src/current_agent.rs","rust/crates/er-cli/src/current_native_capture.rs","rust/crates/er-cli/tests/m9e_current_coop_rebind.rs","rust/crates/er-cli/tests/support/m9e_coop_cli_process.rs","rust/crates/er-env/src/current.rs","rust/crates/er-kernel-worker/src/protocol_v2.rs","rust/crates/er-kernel-worker/src/runtime_v2.rs","rust/crates/er-lab/Cargo.toml","rust/crates/er-lab/src/kernel_reload/endpoint_v2.rs","rust/crates/er-lab/src/kernel_reload/supervisor_v2.rs","rust/crates/er-lab/src/kernel_reload/types_v2.rs","rust/crates/er-lab/tests/current_worker_rebind_v2.rs","rust/crates/er-progression/src/current_friendship_owner.rs","rust/crates/er-progression/tests/m9e_owned_friendship.rs","rust/crates/er-repro/src/current.rs","rust/crates/er-repro/tests/m9e_current_rebind_repro.rs"]
...
RECOVERY_PATHS += ["rust/crates/er-ai/src/lib.rs","rust/crates/er-ai/src/m9e_standard_attack_score.rs","rust/crates/er-ai/tests/m9e_standard_attack_score.rs","rust/crates/er-game/src/lib.rs","rust/crates/er-game/src/m9e_ai_score_query.rs"]
RECOVERY_PATHS += ["src/rust-browser/adapters/current-rtc-transport-v2.ts","src/rust-browser/routes/rust-current-rtc-rebind-entry.ts","test/browser/rust-browser/m9e-v7-rebind-rtc.spec.ts","test/browser/rust-browser/m9e-v7-rebind-rtc-transport.spec.ts","test/browser/rust-browser/m9e-v7-rebind-rtc-owner.spec.ts"]
RECOVERY_PATHS += ["rust/crates/er-progression/src/current_party_experience.rs","rust/crates/er-progression/tests/m9e_party_experience.rs"]
RECOVERY_PATHS += ["rust/crates/er-progression/src/current_phase_experience.rs","rust/crates/er-progression/tests/m9e_phase_experience.rs","rust/crates/er-progression/tests/m9e_held_experience.rs"]
RECOVERY_PATHS += ["rust/crates/er-progression/src/current_phase_tree.rs","rust/crates/er-state/src/current_phase_tree.rs","rust/crates/er-progression/tests/m9e_phase_tree.rs","rust/crates/er-progression/tests/m9e_phase_tree_queries.rs","scripts/ci/m9e_phase_tree_oracle.mjs","scripts/ci/m9e_phase_tree_queries_oracle.mjs"]
RECOVERY_PATHS += ["rust/crates/er-ai/src/party_snapshots.rs","rust/crates/er-game/src/m9_new_run.rs","rust/crates/er-scenario/src/party_requirements.rs","rust/crates/er-scenario/src/training_session.rs","rust/crates/er-state/src/m7_state.rs","rust/crates/er-testkit/tests/m7_system_proof.rs","scripts/ci/m9e_starter_pokerus_oracle.mjs"]
RECOVERY_PATHS += ["rust/crates/er-battle/src/current_move_targets.rs","rust/crates/er-battle/src/lib.rs","rust/crates/er-battle/tests/m9e_current_move_targets.rs","scripts/ci/m9e_current_move_targets_oracle.mjs"]
...
def decode_owned_foundation_inventory(raw):
    """Lossless bounded wire transport; schema/count/identity checks follow."""
    if len(raw) > 65536:
        raise RuntimeError("owned foundation inventory wire limit")
    document = json.loads(raw)
    if not isinstance(document, dict) or document.get("encoding") != "owned-inventory-zlib-v1":
        return document
    if (set(document) != {"encoding", "decoded_bytes", "decoded_sha256", "payload_base64"}
            or type(document["decoded_bytes"]) is not int or not 0 < document["decoded_bytes"] <= 131072
            or not isinstance(document["decoded_sha256"], str)
            or re.fullmatch(r"[0-9a-f]{64}", document["decoded_sha256"]) is None
            or not isinstance(document["payload_base64"], str)):
        raise RuntimeError("owned foundation inventory wire provenance")
    try:
        payload = base64.b64decode(document["payload_base64"], validate=True)
        if not 0 < len(payload) <= 49152:
            raise ValueError("compressed inventory bound")
        stream = zlib.decompressobj()
        decoded = stream.decompress(payload, document["decoded_bytes"] + 1)
        if (len(decoded) != document["decoded_bytes"] or not stream.eof
                or stream.unused_data or stream.unconsumed_tail
                or hashlib.sha256(decoded).hexdigest() != document["decoded_sha256"]):
            raise ValueError("complete exact inventory stream required")
    except (ValueError, zlib.error) as error:
        raise RuntimeError("owned foundation inventory wire payload") from error
...
def owned_foundation_inventory():
    ...
    document = decode_owned_foundation_inventory(raw)
    expected = {"schema_version": 2, "prior_tests": 759, "prior_targets": 98, "tests": 858, "targets": 116}
    ...
    # Source schema 2 omits empty exclusion vectors. Restore them before the
    # strict logical decoder and the byte-exact prior759 identity/exclusion hash.
    if not isinstance(document["inventory"], list):
        raise RuntimeError("owned foundation inventory is not an array")
    rows = canonical_owned_inventory([
        {"historical_excluded_ids": [], **row} if isinstance(row, dict) else row
        for row in document["inventory"]
    ])
    if len(rows) != 116 or sum(len(row["ids"]) for row in rows) != 858:
        raise RuntimeError("owned foundation inventory count differs")
    prior = []
    for row in rows:
        key = row["crate"] + ":" + row["target"]
        additions = OWNED_EXISTING_TARGET_ADDITIONS.get(key, document["additions"].get(key, []))
        ...
        if key in OWNED_FOUNDATION_TEST_IDS:
            ...
            # er-web:er_web existed with five cases in the exact759 baseline.
            # Its four qualified additions must not remove the original target.
            if key not in {"er-web:er_web", "er-kernel:m9e_game_kernel_v7"}:
                continue
...
def validate_owned_foundation_inventory(plan, inventory):
    ...
    if (type(required) is not bool
            or ((selected & (set(OWNED_FOUNDATION_TEST_IDS) - set(OWNED_EXISTING_TARGET_ADDITIONS)) or plan.get("current_recovery_integration")) and not required)):
    ...
    if plan.get("current_recovery_integration"):
        if (plan.get("owned_foundation_inventory_sha256") != OWNED_FOUNDATION_INVENTORY_SHA256
            ...
            raise RuntimeError("owned foundation complete858/116 inventory differs")
...
def plan():
    ...
    # query products. Their six-file union is explicit; no neighbor is absorbed.
    ...
    ai_changes = [path for path in product_changes if path in AI_COMMAND_PATHS] if recovery_session else product_changes
    ai_commands_session, ai_commands_installed = select_ai_command_scope(config, ai_changes)
    ...
    if recovery_session:
        boundaries = [path for path in boundaries if path not in RECOVERY_PATHS]
    if coop_session:
    ...
    replacement_required = replacement_installed and "er-kernel" in selected
    result["requires_natural_replacement"] = replacement_required
    if replacement_required:
        result["required_native_targets"] = merge_targets(result["required_native_targets"], {"er-kernel": [REPLACEMENT_TARGET]})
    ...
    if campaign_required:
        ...
        for crate, target in CAMPAIGN_TARGETS.items():
            ...
            if result["execution_scope"] is not None:
                result["execution_scope"] = merge_targets(result["execution_scope"], {crate: [target]})
    result["requires_natural_coop_campaign"] = campaign_required
    if campaign_required:
        result["required_native_targets"] = merge_targets(result["required_native_targets"], {"er-kernel": [COOP_CAMPAIGN_TARGET]})
    ...
    from m9e_browser_rebind import source_binding as browser_rebind_binding
    result["requires_current_browser_rebind"] = bool(result["requires_owned_foundations"] and result["current_recovery_integration"])
    result["current_browser_rebind_binding"] = (
        browser_rebind_binding(ROOT, capture(["git", "rev-parse", "HEAD"]))
        if result["requires_current_browser_rebind"] else None)
    from m9e_browser_rebind_physical import source_binding as physical_rebind_binding
    result["requires_current_browser_rebind_physical"] = bool(
        result["requires_current_browser_rebind"]
        and (ROOT / "src/rust-browser/adapters/current-rtc-transport-v2.ts").is_file())
    result["current_browser_rebind_physical_binding"] = (
        physical_rebind_binding(ROOT, capture(["git", "rev-parse", "HEAD"]))
        if result["requires_current_browser_rebind_physical"] else None)
    ...
    if rng_required:
        ...
        result["required_native_targets"] = merge_targets(result["required_native_targets"], {"er-rng": list(RNG_TEST_IDS)})
        result["required_native_test_ids"] = {**result["required_native_test_ids"], **{"er-rng:" + target: list(ids) for target, ids in RNG_TEST_IDS.items()}}
        if result["execution_scope"] is not None:
            result["execution_scope"] = merge_targets(result["execution_scope"], {"er-rng": list(RNG_TEST_IDS)})
...
def browser_worker_codec_evidence(report):
    ...
    if (report.get("success") is not True or report.get("numTotalTests") != 5 or report.get("numPassedTests") != 5
            or len(suites) != 1 or (path != expected_path and not path.endswith("/" + expected_path))
            or len(assertions) != 5 or {item.get("fullName") for item in assertions} != set(WORKER_CODEC_IDS)
    ...
    return {"expected": 5, "passed": 5, "failed": 0, "skipped": 0, "selected_test_ids": WORKER_CODEC_IDS}
...
def native_execution_order(selection, enumerated):
    ...
    if selection.get("rule_worker"):
        from m9e_rulechange import RULE_TARGET
        ordered = native_execution_order({**selection, "rule_worker": None}, enumerated)
        return sorted(ordered, key=lambda item: (item[4].name, item[2]) != ("er-cli", RULE_TARGET))
...
def main(preflight_failure=None):
    ...
    try:
        ...
        from m9e_rulechange import RULE_TARGET, RULE_TEST, current_rule_worker, bounded_rule_feedback
        ...
        if (os.environ.get("M9E_NATIVE_LANE", "a") == "a"
            ...
            oracle_path = FULL / "standard-score-source-cases.tsv"
            oracle_log = run(["node", str(oracle_script), str(oracle_path)], "standard-score-source-oracle", ROOT)
            if not 0 < oracle_log.stat().st_size <= 16384:
                raise RuntimeError("bounded actual standard score oracle receipt required")
            oracle = json.loads(oracle_log.read_bytes())
            if (oracle.get("runtime") != "v24.9.0" or oracle.get("cases") != 1280
                    or oracle.get("function_sha256") != "f039ddee32c6786d688f42b4a43f90b30043d698a1ea5383de3400305ef97946"
                    or oracle.get("output_bytes") != 41184 or oracle_path.stat().st_size != 41184
                    or oracle.get("output_sha256") != "f39e0d878f2a93b49654dce7432d66ff04a3cf45f7d4800d81793d4e6770bcdd"
                    or digest(oracle_path) != oracle["output_sha256"]):
                raise RuntimeError("complete actual standard score source cases differ")
            summary["standard_score_oracle"] = oracle
            os.environ["M9E_STANDARD_SCORE_ORACLE"] = str(oracle_path)
        if (os.environ.get("M9E_NATIVE_LANE", "a") == "a"
                and any((cwd.name, name) == ("er-progression", "m9e_party_experience") for name, cwd in binaries.values())):
            oracle_script = ROOT / "scripts/ci/m9e_party_xp_oracle.mjs"
            if digest(oracle_script) != "fde49b764fb994551eb8bf2128f175f63edcee9fdeb16b46d9a36046848774bb":
                raise RuntimeError("qualified party XP oracle source differs")
            run(["npm", "install", "--global", "pnpm@10.33.2"], "party-xp-pnpm", ROOT)
            run(["pnpm", "install", "--frozen-lockfile", "--ignore-scripts"], "party-xp-dependencies", ROOT)
            oracle_dir = FULL / "party-xp"
            oracle_dir.mkdir()
            oracle_path = oracle_dir / "source-cases.tsv"
            oracle_log = run(["node", "--disable-warning=ExperimentalWarning", str(oracle_script), str(oracle_path)], "party-xp-source-oracle", ROOT)
            if not 0 < oracle_log.stat().st_size <= 16384:
                raise RuntimeError("bounded actual party XP source receipt required")
            oracle = json.loads(oracle_log.read_bytes())
            if (oracle.get("runtime") != "v24.9.0" or oracle.get("cases") != 144
                    or oracle.get("function_sha256") != "37f19d82a8772ad0edddd7724a70994b0a11aa03b8901bfd10a29ed334d6e96c"
                    or oracle.get("function_bytes") != 4977 or oracle.get("friendship_argument") != 3
                    or oracle.get("phaser_version") != "3.90.0"
                    or oracle.get("linear_bytes") != 667
                    or oracle.get("linear_sha256") != "b41eefcb431c2fd25ca0f823ef10a1bbb0fe777b006f4993476aabf95208703d"
                    or digest(oracle_dir / "linear-source.js") != oracle["linear_sha256"]
                    or oracle.get("output_bytes") != 10594 or oracle_path.stat().st_size != 10594
                    or oracle.get("output_sha256") != "80658168c8fa7638b481a97e370ff5e8b7cb383342c6374bd31a7037e225b0da"
                    or digest(oracle_path) != oracle["output_sha256"]):
                raise RuntimeError("complete actual party XP source cases differ")
            summary["party_xp_oracle"] = oracle
            os.environ["M9E_PARTY_XP_ORACLE"] = str(oracle_path)
        for label, crate, target, variable, script_path, script_sha, expected_json in [
            ("current-move-targets", "er-battle", "m9e_current_move_targets", "M9E_CURRENT_MOVE_TARGETS_ORACLE", "scripts/ci/m9e_current_move_targets_oracle.mjs", "8bf5b940e404061769d6da25e1a5b22217354d3e85db5c9c6be2f88291d85cf1", "{\"runtime\":\"v24.9.0\",\"source_hashes\":{\"src/field/pokemon.ts\":\"4074ff23323ec01f92422b5666ad0b397a0c73cafd11f158637346b5a35af8fa\",\"src/data/moves/move-utils.ts\":\"6f296e67ba9be531ba12dd1455cbebd04b7fdedfe6ec8cadb2d3df73743d50eb\",\"src/data/battle-format.ts\":\"7619f84967643acc73a39c9e45f76c6a3ff4944b1f1794254bf37c279e9bffe8\",\"src/enums/move-target.ts\":\"dd9272781d53e85b051fe071bb12d23d54c3625892bc973f535f4f14cd68cd80\",\"src/enums/battler-index.ts\":\"a2b1c976090f93826ecf89fc5571a501ef89fd0d1e91263946288a9307c8bd02\",\"src/enums/pokemon-type.ts\":\"4f5a8989b5a3e732c98130316ac72944c32bce851d2e397832a06afe0fa47c82\",\"src/enums/move-flags.ts\":\"ad4f5357dc7a3d42c956269d41a3b4677cc363142df25afa258e6f6225073fa5\"},\"cases\":200,\"whole_target_function\":true,\"whole_line_adjacency\":true,\"whole_enumeration_methods\":true,\"resolved_owner_inputs_only\":true,\"battle_execution_qualified\":false,\"output_bytes\":87304,\"output_sha256\":\"a907b43f1411c093ba91e3ecfd2537384acdafd51ca8dcf650c53a3b1773c031\"}"),
            ("starter-pokerus", "er-game", "m9e_battle_participation", "M9E_STARTER_POKERUS_ORACLE", "scripts/ci/m9e_starter_pokerus_oracle.mjs", "e78726b93b24e5b2d3b96d3305f65facf58357a90d099403c07581ff5b7f2fb4", "{\"runtime\":\"v24.9.0\",\"cases\":4,\"source_hashes\":{\"src/field/pokemon.ts\":\"4074ff23323ec01f92422b5666ad0b397a0c73cafd11f158637346b5a35af8fa\",\"src/phases/select-starter-phase.ts\":\"818c060ada86e24a31a0bb0095e75dd915604d2812e9edf865bd5a17b647fe57\"},\"fresh_assignment_sha256\":\"a1ba54852c64512264241b3d0c5f6537e872255b9a4f34e5043843975e9a1d74\",\"selected_assignment_sha256\":\"6c947542d48426c910f62fec91e13b791764108e1763fecae6bb04972e05e063\",\"whole_constructor\":false,\"whole_starter_phase\":false,\"profile_eligibility_qualified\":false,\"output_bytes\":88,\"output_sha256\":\"9adc63e729ec0dd3bbe020254a9f5769fb6dd05046cf707dab9bb4f2bce81ccf\"}"),
            ("phase-tree", "er-progression", "m9e_phase_tree", "M9E_PHASE_TREE_ORACLE", "scripts/ci/m9e_phase_tree_oracle.mjs", "5bbf7fb65b4e2ccb884759401b13f3bc008c7cde9b73226e823d8e0f57640283", "{\"runtime\":\"v24.9.0\",\"source_hashes\":{\"src/phase-tree.ts\":\"2a152ebab21e2d54e72a0655896ece0d731c48aa82d61d8130d2a30f1e895b3c\"},\"cases\":64,\"whole_class\":true,\"operations\":\"addPhase,deferred addPhase,pushPhase,addBarrier,getNextPhase,clear,clear(true),queuedPhaseNames\",\"output_bytes\":18510,\"output_sha256\":\"990c841e87d3224092011b3ad1c256acbae782b08324d6bfd5adadf9ab6854a2\",\"phase_execution_qualified\":false}"),
            ("phase-tree-queries", "er-progression", "m9e_phase_tree_queries", "M9E_PHASE_TREE_QUERIES_ORACLE", "scripts/ci/m9e_phase_tree_queries_oracle.mjs", "60fb414013144cb5a8491013ea454506243ca63ad99d0cda41a91bbae14dbc90", "{\"runtime\":\"v24.9.0\",\"source_hashes\":{\"src/phase-tree.ts\":\"2a152ebab21e2d54e72a0655896ece0d731c48aa82d61d8130d2a30f1e895b3c\"},\"cases\":64,\"whole_class\":true,\"predicate_order_checked\":true,\"output_bytes\":35920,\"output_sha256\":\"36688bb3ca23174aa75f4bb837174b045dd13a488c9c00129254dcb5219aa1b3\",\"phase_execution_qualified\":false}"),
            ("phase-xp", "er-progression", "m9e_phase_experience", "M9E_PHASE_XP_ORACLE", "scripts/ci/m9e_phase_xp_oracle.mjs", "3ed5c17839b010e5f90fa6325b5c6bc3f2fdacdbf0b9a8ae9bbf39ec30eac768", "{\"cases\":336,\"modifier_class_bytes\":1157,\"modifier_class_sha256\":\"d1702ee3e65959311cfc137706a9a9f81dc124fd5064228d902448d95c8a2443\",\"output_bytes\":9677,\"output_sha256\":\"2ed825e0157992c7aab24bfe7552fa055e024a3410137bdbfa0e4d3f48c9edbf\",\"phase_call_order_checked\":true,\"runtime\":\"v24.9.0\",\"scope\":\"whole actual field/bench phase classes and ExpBoosterModifier; controlled consumers/addExp/presentation boundaries, no pending ownership settlement\",\"source_hashes\":{\"src/modifier/modifier.ts\":\"ce600a1acbe931402679f95832919f8d4ec05ad9e4ff2bce5a9e68b1aaa21b4f\",\"src/phases/exp-phase.ts\":\"e51cceaae1dd3d5ecc635a170908c42bde678f49e71a7f78f1c633d347196b1c\",\"src/phases/show-party-exp-bar-phase.ts\":\"03e9e81b2caa3e219709f4a7b27932caa6e573b46a5c75d10647999e09ddb11c\"}}"),
            ("held-xp", "er-progression", "m9e_held_experience", "M9E_HELD_XP_ORACLE", "scripts/ci/m9e_held_xp_oracle.mjs", "7161541ef0510c118bf77cb5de26d1b6f4a0db53b0a115627ef3b0a8e7e4b9a3", "{\"cases\":288,\"friendship_argument\":3,\"function_bytes\":4977,\"function_sha256\":\"37f19d82a8772ad0edddd7724a70994b0a11aa03b8901bfd10a29ed334d6e96c\",\"held_class_bytes\":1816,\"held_class_sha256\":\"7208133d6fc1ad313cad5de501370c19761c1ad1761e381e3abd80fbbf8cda17\",\"linear_bytes\":667,\"linear_sha256\":\"b41eefcb431c2fd25ca0f823ef10a1bbb0fe777b006f4993476aabf95208703d\",\"output_bytes\":28052,\"output_sha256\":\"6d606819d2100cb5ddeefa76108c1866a73ea72efa495d80123b6279f78a2603\",\"phaser_version\":\"3.90.0\",\"runtime\":\"v24.9.0\",\"scope\":\"actual applyPartyExp and PokemonExpBoosterModifier; resolved held ownership, normal Classic without Macho Brace; no phase execution or pending-owner settlement\",\"source_hashes\":{\"pnpm-lock.yaml\":\"dcbcaf6df44509c71b28becffdd70b33a7410a0873f5b1297ede84150a6effff\",\"src/battle-scene.ts\":\"ac66742dffd05d97104c375bb4b0d4b2585873627a66413e34ae233bc47c7100\",\"src/data/balance/starters.ts\":\"21bd9442711f1f7381f5e7e5c4a51dac43db0584272fd5b4767493f8a68e39ef\",\"src/modifier/modifier.ts\":\"ce600a1acbe931402679f95832919f8d4ec05ad9e4ff2bce5a9e68b1aaa21b4f\"}}"),
        ]:
            if (os.environ.get("M9E_NATIVE_LANE", "a") != "a"
                    or not any((cwd.name, name) == (crate, target) for name, cwd in binaries.values())):
                continue
            oracle_script = ROOT / script_path
            if digest(oracle_script) != script_sha:
                raise RuntimeError("qualified XP oracle source differs: " + label)
            if label == "held-xp":
                run(["npm", "install", "--global", "pnpm@10.33.2"], "held-xp-pnpm", ROOT)
                run(["pnpm", "install", "--frozen-lockfile", "--ignore-scripts"], "held-xp-dependencies", ROOT)
            oracle_dir = FULL / label
            oracle_dir.mkdir()
            oracle_path = oracle_dir / "source-cases.tsv"
            oracle_log = run(["node", "--disable-warning=ExperimentalWarning", str(oracle_script), str(oracle_path)], label + "-source-oracle", ROOT)
            if not 0 < oracle_log.stat().st_size <= 16384:
                raise RuntimeError("bounded actual XP source receipt required: " + label)
            oracle = json.loads(oracle_log.read_bytes())
            expected = json.loads(expected_json)
            if (oracle != expected or oracle_path.stat().st_size != expected["output_bytes"]
                    or digest(oracle_path) != expected["output_sha256"]
                    or any(digest(ROOT / path) != value for path, value in expected["source_hashes"].items())):
                raise RuntimeError("complete actual qualified XP source observations differ: " + label)
            if "linear_sha256" in expected:
                linear = oracle_dir / "linear-source.js"
                if linear.stat().st_size != expected["linear_bytes"] or digest(linear) != expected["linear_sha256"]:
                    raise RuntimeError("actual qualified Phaser dependency differs")
            summary[label.replace("-", "_") + "_oracle"] = oracle
            os.environ[variable] = str(oracle_path)
        enumerated = []
        ...
        for index, binary, name, ids, cwd, excluded_ids, env in enumerated:
            ...
            coop_campaign_target = (cwd.name, name) == coop_campaign.TARGET
            rule_target = (cwd.name, name) == ("er-cli", RULE_TARGET)
            rule_context = contextlib.nullcontext((env, None))
            if rule_target:
                if (ids != [RULE_TEST] or excluded_ids or os.environ.get("M9E_PHASE") != "native"
                        or os.environ.get("M9E_NATIVE_LANE") != "c" or "rule_worker" in summary):
                    raise RuntimeError("rulechange requires exact-one native C execution")
                write_progress(summary, "rule-variant", name)
                rule_feedback = bounded_rule_feedback(sys.modules[__name__], native_deadline)
                rule_context = current_rule_worker(rule_feedback, summary, worker_executable)
            with rule_context as (env, rule_evidence):
                ...
                try:
                    if (cwd.name, name) == cost.TARGET:
                        ...
                        code = 0
                    elif coop_campaign_target:
                        if (not selection.get("requires_natural_coop_campaign") or excluded_ids
                                or "natural_cooperative_campaign" in summary):
                            raise RuntimeError("cooperative campaign optimized override is outside its exact scope")
                        summary["natural_cooperative_campaign"] = coop_campaign.execute(
                            ROOT, FULL, release_identity, ids, native_deadline)
                        code = 0
                    elif coop_target:
                        ...
                        result = cost.run_bounded(command, cwd=cwd, environment=env, output=output,
                                                  seconds=600, byte_limit=16384, global_deadline=native_deadline)
                        code = 0
                    else:
                        with output.open("w") as stream:
                ...
                if replay_target:
                    ...
                    actual = summary["natural_cooperative_campaign"]["tests"]
                    passed, failed, skipped = actual["passed"], actual["failed"], actual["skipped"]
                elif coop_target:
            ...
            if rule_evidence is not None:
                ...
                # Only exact-one success within the shared deadline permits publication.
                if time.monotonic() > native_deadline:
                    raise RuntimeError("rule context cleanup exceeded the native deadline")
        ...
        if len(encoded_summary) > 16000:
            ...
            encoded_summary = (json.dumps(summary, indent=2) + "\n").encode()
        if len(encoded_summary) > 16000:
            for key in ("native_target_timing_ms", "required_native_target_counts", "build_only_targets", "timing_ms", "current_cost_probe", "standard_score_oracle", "party_xp_oracle", "phase_xp_oracle", "held_xp_oracle", "phase_tree_oracle", "phase_tree_queries_oracle", "starter_pokerus_oracle", "current_move_targets_oracle"):
                if key in summary:
