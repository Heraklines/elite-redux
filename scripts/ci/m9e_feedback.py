...
OWNED_FOUNDATION_INVENTORY_SHA256 = "976c76a25228f524150fe1dff2564240d5ccd9e57e02e51947c826702f4aaa78"
...
def owned_foundation_inventory():
    ...
    expected = {"schema_version": 2, "prior_tests": 759, "prior_targets": 98, "tests": 814, "targets": 107}
    ...
    if len(rows) != 107 or sum(len(row["ids"]) for row in rows) != 814:
...
def validate_owned_foundation_inventory(plan, inventory):
    ...
    if plan.get("current_recovery_integration"):
        if (plan.get("owned_foundation_inventory_sha256") != OWNED_FOUNDATION_INVENTORY_SHA256
            ...
            raise RuntimeError("owned foundation complete814/107 inventory differs")
