...
OWNED_FOUNDATION_INVENTORY_SHA256 = "56f98025bd2955287642e57cb66eabab02ce92987f643b276ddfd7ac161b6e98"
...
def owned_foundation_inventory():
    ...
    expected = {"schema_version": 2, "prior_tests": 759, "prior_targets": 98, "tests": 830, "targets": 110}
    ...
    if len(rows) != 110 or sum(len(row["ids"]) for row in rows) != 830:
...
def validate_owned_foundation_inventory(plan, inventory):
    ...
    if plan.get("current_recovery_integration"):
        if (plan.get("owned_foundation_inventory_sha256") != OWNED_FOUNDATION_INVENTORY_SHA256
            ...
            raise RuntimeError("owned foundation complete830/110 inventory differs")
