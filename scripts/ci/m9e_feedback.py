...
OWNED_FOUNDATION_INVENTORY_SHA256 = "00e272fdef5d61a90617626cee1f409d0f78066d8b51f341f5b93ceea8c79afa"
...
def owned_foundation_inventory():
    ...
    expected = {"schema_version": 2, "prior_tests": 759, "prior_targets": 98, "tests": 834, "targets": 111}
    ...
    if len(rows) != 111 or sum(len(row["ids"]) for row in rows) != 834:
...
def validate_owned_foundation_inventory(plan, inventory):
    ...
    if plan.get("current_recovery_integration"):
        if (plan.get("owned_foundation_inventory_sha256") != OWNED_FOUNDATION_INVENTORY_SHA256
            ...
            raise RuntimeError("owned foundation complete834/111 inventory differs")
