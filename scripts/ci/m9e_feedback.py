...
OWNED_FOUNDATION_INVENTORY_SHA256 = "d046f7d746334c51d94907d8c90eade0876b2c24b5db6234d4e9da3e628b3783"
...
def owned_foundation_inventory():
    ...
    expected = {"schema_version": 2, "prior_tests": 759, "prior_targets": 98, "tests": 850, "targets": 115}
    ...
    if len(rows) != 115 or sum(len(row["ids"]) for row in rows) != 850:
...
def validate_owned_foundation_inventory(plan, inventory):
    ...
    if plan.get("current_recovery_integration"):
        if (plan.get("owned_foundation_inventory_sha256") != OWNED_FOUNDATION_INVENTORY_SHA256
            ...
            raise RuntimeError("owned foundation complete850/115 inventory differs")
