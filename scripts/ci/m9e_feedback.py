...
def owned_foundation_inventory():
    ...
    expected = {"schema_version": 2, "prior_tests": 759, "prior_targets": 98, "tests": 819, "targets": 108}
    ...
    if len(rows) != 108 or sum(len(row["ids"]) for row in rows) != 819:
