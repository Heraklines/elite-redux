...
OWNED_FOUNDATION_INVENTORY_SHA256 = "fbb1e9dccb176a77b635ba8ea7a78a80c1c213d8eafcac85de342ab2a1ef0466"
...
def owned_foundation_inventory():
    ...
    expected = {"schema_version": 1, "prior_tests": 759, "prior_targets": 98, "tests": 809, "targets": 106}
    ...
    if len(rows) != 106 or sum(len(row["ids"]) for row in rows) != 809:
...
def validate_owned_foundation_inventory(plan, inventory):
    ...
    if plan.get("current_recovery_integration"):
        if (plan.get("owned_foundation_inventory_sha256") != OWNED_FOUNDATION_INVENTORY_SHA256
            ...
            raise RuntimeError("owned foundation complete809/106 inventory differs")
