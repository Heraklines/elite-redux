...
BASE = "f0988539162e6f88a49c1d45260453813470b908"
PROBE_PARENT = BASE
BRANCH = "codex/m9e-victory-allocation-probe-20260923"
OWNED = {
...
def main():
    ...
    result = {
        ...
        "commands": COMMANDS,
        "scope": "two complete native binaries on exact main-candidate source; not whole-game qualification",
    }
    try:
