...
REPORT = Path(os.environ["RUNNER_TEMP"]) / "m9e-natural-progression-focused"
FULL = REPORT / "diagnostics"
COMPACT = REPORT / "compact"
TARGET = REPORT / "target"
os.environ["CARGO_TARGET_DIR"] = str(TARGET)
DEADLINE = time.monotonic() + 1800
RUST_SOURCES = ["rust/crates/er-kernel/src/game_kernel_v7.rs", "rust/crates/er-kernel/tests/m9e_natural_progression_v7.rs",
                "rust/crates/er-game/src/m9e_runtime_v6.rs", "rust/crates/er-progression/src/progression.rs"]
TEST_TARGET = "m9e_natural_progression_v7"
TEST_IDS = ["natural_victory_experience_recalculates_stats_preserves_damage_and_restores"]
sequence = 0
logs = {}
failed_log = None
...
def main(summary):
    ...
    sources = [*RUST_SOURCES, "rust/crates/er-kernel/src/game_kernel_v7.rs", "rust/crates/er-kernel/src/snapshot_v7.rs",
               ...
               "scripts/ci/m9e_current_cost.py", "scripts/ci/m9e_natural_progression_diagnostic.py",
               ".github/workflows/m9e-natural-progression-focused.yml",
    ...
    if listing != "".join(name + ": test\n" for name in TEST_IDS):
        raise RuntimeError("exact one-test inventory differs")
...
if __name__ == "__main__":
    ...
    summary = {"status": "failed", "qualification": "focused natural first-victory level/stat progression only; no full campaign or M9 qualification",
