"""Remote F for natural current replacement; final qualification remains separate."""
import hashlib
import json
import os
...
REPORT = Path(os.environ["RUNNER_TEMP"]) / "m9e-natural-replacement-focused"
FULL = REPORT / "diagnostics"
COMPACT = REPORT / "compact"
TARGET = REPORT / "target"
os.environ["CARGO_TARGET_DIR"] = str(TARGET)
DEADLINE = time.monotonic() + 1800
RUST_SOURCES = ["rust/crates/er-game/src/m9e_runtime_v6.rs", "rust/crates/er-kernel/tests/m9e_natural_replacement_v7.rs"]
TEST_TARGET = "m9e_natural_replacement_v7"
TEST_IDS = ["natural_faint_offers_owned_reserves_restores_and_continues_raw_battle",
...
def main(summary):
    ...
    sources = [*RUST_SOURCES, "rust/crates/er-kernel/src/game_kernel_v7.rs", "rust/crates/er-kernel/src/snapshot_v7.rs",
               ...
               "scripts/ci/m9e_current_cost.py", "scripts/ci/m9e_natural_replacement_diagnostic.py",
               ".github/workflows/m9e-natural-replacement-focused.yml",
...
if __name__ == "__main__":
    ...
    summary = {"status": "failed", "qualification": "focused natural current replacement only; no full campaign, RTC or M9 qualification",
