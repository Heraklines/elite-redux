...
BASE = "db8459da26a25d383233b7a3a90d01c6da265fb2"
MODULE = "rust/crates/er-progression/src/current_phase_tree.rs"
TEST = "m9e_phase_tree"
CI = [".github/workflows/m9e-phase-tree-focused.yml", "scripts/ci/m9e_phase_tree.py", "scripts/ci/m9e_phase_tree_oracle.mjs"]
IDS = ["every_actual_source_trace_and_intermediate_snapshot_matches", "descendant_level_up_tasks_precede_barrier_and_recipient_siblings", "source_clear_preserves_deferred_flag_and_retains_only_deepest_level", "malformed_restore_and_excess_capacity_leave_queue_unchanged"]
ROOT = Path.cwd().resolve()
RUNNER = Path(os.environ["RUNNER_TEMP"]).resolve()
OUT = RUNNER / "m9e-phase-tree"
TARGET = RUNNER / "m9e-phase-tree-target"
START = float(os.environ["M9E_STARTED_AT"])
DEADLINE = START + 1800
COMMANDS = []
PRODUCTS = {"rust/crates/er-progression/src/current_phase_tree.rs":"9ad12b810b370f0f86813769287502e58f1c6ffc0f778581809c8464eb3a3aea","rust/crates/er-progression/src/lib.rs":"725c9a073583a5939ec8d3541eb8d0165ab5ff89491079e11e4490c0cb8fbfd1","rust/crates/er-progression/tests/m9e_phase_tree.rs":"23f2ef640f4658083f9346b6519ce65b11eedf04db5442fa3d4eb28f7888d539"}
...
def main():
    ...
    try:
        ...
        require(sha(old_lib) == "4672b76d5335be4268e8cb6eda85decc9c2d937e5535975055ebef90229b6c5e", "prior whole progression library")
        require((ROOT / "rust/crates/er-progression/src/lib.rs").read_bytes().replace(b"pub mod current_phase_tree;\n", b"") == old_lib, "all original progression source preserved")
        ...
        os.environ["M9E_PHASE_TREE_ORACLE"] = str(oracle_path)
        ...
        before = b"siblings.push_front(phase);"
        after = b"siblings.push_back(phase);"
        require(original.count(before) == 1, "unique causal sibling barrier ordering mutation")
        ...
        result["negative"] = {"passed": 2, "failed": 2, "mutation": "barrier incorrectly follows previously queued siblings"}
