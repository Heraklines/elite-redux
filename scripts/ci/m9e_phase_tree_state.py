...
BASE = "63bc1fb8c232c5ce3117f236d17c7e6eb591fc44"
MODULE = "rust/crates/er-state/src/current_phase_tree.rs"
TEST = "m9e_phase_tree_queries"
CI = [".github/workflows/m9e-phase-tree-state-focused.yml", "scripts/ci/m9e_phase_tree_state.py"]
...
OUT = RUNNER / "m9e-phase-tree-state"
TARGET = RUNNER / "m9e-phase-tree-state-target"
START = float(os.environ["M9E_STARTED_AT"])
DEADLINE = START + 1800
COMMANDS = []
PRODUCTS = {"rust/crates/er-state/src/current_phase_tree.rs":"7432e32ef6b2f3ebbe77b3187f295779934d171791de05bc41290a37a6797950","rust/crates/er-state/src/lib.rs":"607aba30886591bc590a05368da49bb68958a37965b1bdf67bc15f922611f3b0","rust/crates/er-progression/src/current_phase_tree.rs":"e365c290dde63105319be47dda53afd22ebbc6259324c2579381a113956981ee"}
...
def main():
    ...
    result = {"status": "failed", "source_sha": os.environ["GITHUB_SHA"],
              ...
              "scope": "same whole qualified PhaseTree implementation owned by er-state and re-exported by progression; complete original and query witnesses, no phase execution or pending experience settlement"}
    original = None
    try:
        ...
        dependencies = ["src/phase-tree.ts",
                        ...
                        "rust/crates/er-state/src/current_experience_owner.rs", "rust/crates/er-game/src/m9e_runtime_v6.rs", "rust/crates/er-progression/src/lib.rs", "rust/crates/er-progression/tests/m9e_phase_tree.rs", "scripts/ci/m9e_phase_tree_oracle.mjs", "rust/crates/er-progression/tests/m9e_phase_tree_queries.rs", "scripts/ci/m9e_phase_tree_queries_oracle.mjs"]
        ...
        require((ROOT / MODULE).read_bytes() == git("show", BASE + ":rust/crates/er-progression/src/current_phase_tree.rs"), "entire qualified implementation relocated without changes")
        state_lib = (ROOT / "rust/crates/er-state/src/lib.rs").read_bytes()
        require(state_lib.replace(b"pub mod current_phase_tree;\n", b"") == git("show", BASE + ":rust/crates/er-state/src/lib.rs"), "all prior state library source preserved")
        ...
        oracle = json.loads(run("source-oracle", ["node", "--disable-warning=ExperimentalWarning", "scripts/ci/m9e_phase_tree_queries_oracle.mjs", str(oracle_path)]))
