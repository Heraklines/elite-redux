...
BASE = "b525ad0917d9a49a5a6f8846c5ad58f3c64a1c65"
SOURCE = "rust/crates/er-game/tests/m9e_move_recoil.rs"
CI = [".github/workflows/m9e-recoil-bundle-focused.yml", "scripts/ci/m9e_recoil_bundle.py"]
DELTAS = json.loads(r'''{"before":{"rust/crates/er-game/tests/m9e_move_recoil.rs":"b388816b41f69228bb17803815bf9ab348afb75a97c03138f3f033056515fcf6"},"after":{"rust/crates/er-game/tests/m9e_move_recoil.rs":"34d43c19eee89efb99ac218e615613ebea64b3ace0f46c853b7caf59990bd9ea"}}''')
ROOT = Path.cwd().resolve()
RUNNER = Path(os.environ["RUNNER_TEMP"]).resolve()
OUT = RUNNER / "m9e-recoil-bundle"
TARGET = RUNNER / "m9e-recoil-bundle-target"
...
def main():
    ...
    try:
        ...
        require(TARGET.resolve().parent == RUNNER and TARGET.name == "m9e-recoil-bundle-target",
