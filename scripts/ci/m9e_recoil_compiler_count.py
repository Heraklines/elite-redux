...
CI = [".github/workflows/m9e-recoil-compiler-count-focused.yml", "scripts/ci/m9e_recoil_compiler_count.py"]
DELTAS = json.loads(r'''{"before":{"rust/crates/er-content-compiler/tests/m9e_full_content.rs":"c91c6c84f55d7bd91e3f2054fa49784daeab66f976de8326eb071b3f2c5783bf"},"after":{"rust/crates/er-content-compiler/tests/m9e_full_content.rs":"b54173ccc7de4d467e3a91f437e03d859eea7c3d1bcd354566c9272c739291bf"}}''')
ROOT = Path.cwd().resolve()
RUNNER = Path(os.environ["RUNNER_TEMP"]).resolve()
OUT = RUNNER / "m9e-recoil-compiler-count"
TARGET = RUNNER / "m9e-recoil-compiler-count-target"
...
def main():
    ...
    try:
        ...
        require(TARGET.resolve().parent == RUNNER and TARGET.name == "m9e-recoil-compiler-count-target",
