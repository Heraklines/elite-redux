"""Actual paired published-recoil content traces; original native/Wasm goldens remain unchanged."""
import copy
import hashlib
import itertools
import json
...
OUT = RUNNER / "m9e-recoil-parity"
TARGET = RUNNER / "m9e-recoil-parity-target"
START = int(os.environ["M9E_STARTED_AT"])
DEADLINE = START + 1800
COMMANDS = []
BASE = "b4862e9db04455732673bf3e75478f2ef9f63e75"
OLD = "3daecc23403192137fbce4ff2a07f693f6e920fd"
SOURCE = "rust/crates/er-wasm/tests/m9e_parity.rs"
ORIGINAL_BYTES = 29848
ORIGINAL_HASH = "872a38b8774ef72e2e16c18c085d71a8714f8d54d9a7306d3cadfb48f231e977"
DIAGNOSTIC_HASH = "5964738a6c3d146c9d0f5221f7e4f784dce93d37c2d560c7f3d072b51fc01925"
CI = [".github/workflows/m9e-recoil-parity-focused.yml", "scripts/ci/m9e_recoil_parity.py"]
...
def main():
    ...
    try:
        ...
        require(TARGET.resolve().parent == RUNNER and TARGET.name == "m9e-recoil-parity-target", "cleanup must remain in owned runner target")
