...
CI = [".github/workflows/m9e-recoil-published-focused.yml", "scripts/ci/m9e_recoil_published.py"]
DELTAS = json.loads(r'''{"after":{"rust/crates/er-game/tests/m9e_move_recoil.rs":"54d5b992f11202f1649f94bb22af59165660ff2168faa84fbfd1b3b3142896dd"},"before":{"rust/crates/er-game/tests/m9e_move_recoil.rs":"34d43c19eee89efb99ac218e615613ebea64b3ace0f46c853b7caf59990bd9ea"}}''')
...
OUT = RUNNER / "m9e-recoil-published"
TARGET = RUNNER / "m9e-recoil-published-target"
...
def main():
    ...
    try:
        ...
        require(TARGET.resolve().parent == RUNNER and TARGET.name == "m9e-recoil-published-target",
