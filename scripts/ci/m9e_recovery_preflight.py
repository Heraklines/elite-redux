...
def main():
    ...
    if len(product) != 12 or set(product) != set(feedback.RECOVERY_PATHS):
        raise RuntimeError("combined product source must be exactly the twelve reviewed paths")
    ...
    projected["tests"] = {"selected": 665, "executed": 665, "passed": 665, "failed": 0, "skipped": 0}
    ...
    print("Passed: actual combined twelve-path source scope, all79 prior targets, exact eight new IDs, and retained co-op/platform/cost/rule/mutant obligations.")
