"""Remote-only actual current target execution with retained whole-target regressions."""
import base64
import difflib
import hashlib
import json
...
def main():
    ...
    try:
        ...
        require(result["tests_executed"] == 47, "all41 unchanged tests plus6 actual execution witnesses")
        ...
        require(TARGET.resolve().parent == RUNNER and TARGET.name == "m9e-target-execution-target", "cleanup ownership")
