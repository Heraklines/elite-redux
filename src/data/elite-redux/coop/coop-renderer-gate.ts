...
export const COOP_RENDERER_ALLOWED_PHASES: ReadonlySet<string> = new Set<string>([
  ...
  "CoopFinalizeEntryPresentationPhase", // proves every pre-command cue before command control opens
  ...
  "CoopTransformReplayPhase", // exact host-authored Transform material and appearance
