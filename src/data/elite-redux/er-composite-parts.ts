...
export const ER_COMPOSITE_PARTS: Readonly<Record<number, ErCompositeEntry>> = {
  ...
  616: { erAbilityId: 616, parts: [{ kind: "er", erAbilityId: 557 }], unresolvedParts: ["Ignores Protect", "screens break on readied turn"], hasRider: true },
  ...
  699: { erAbilityId: 699, parts: [{ kind: "er", erAbilityId: 477 }], hasRider: false },
  ...
  813: { erAbilityId: 813, parts: [], unresolvedParts: ["Normal moves are flagged as Punch", "Kick moves"], hasRider: true },
  ...
  851: { erAbilityId: 851, parts: [], unresolvedParts: ["Adds Dragon-type", "moves have 30% Bad Poison chance"], hasRider: true },
