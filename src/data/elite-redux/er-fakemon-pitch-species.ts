...
// Final-stage kits; pre-evolutions use their separately documented abilities.
...
export const ER_FAKEMON_PITCH_SPECIES: readonly PitchSpeciesDef[] = [
  {
    ...
    stats: [80, 70, 70, 25, 60, 15],
    actives: [AbilityId.INTIMIDATE, 5164, 5247],
    innates: [5038, 5454, 5096],
    weight: 12.5,
  ...
  },
  {
    ...
    stats: [90, 95, 95, 35, 75, 20],
    actives: [5067, 5121, 5247],
    innates: [5140, 5454, 5203],
    weight: 40,
  ...
  },
  {
    ...
    actives: [6007, AbilityId.BULLETPROOF, 5212],
    innates: [5160, AbilityId.LEVITATE, AbilityId.JUSTIFIED],
    weight: 36.5,
  ...
  },
  {
    ...
    stats: [20, 60, 25, 30, 50, 80],
    actives: [5007, 5055, 5116],
    innates: [5140, 5031, 5093],
    weight: 0.8,
  ...
  },
  {
    ...
    stats: [55, 75, 60, 75, 55, 90],
    actives: [5452, AbilityId.WATER_ABSORB, 5128],
    innates: [6034, AbilityId.CUTE_CHARM, 5093],
    weight: 30,
