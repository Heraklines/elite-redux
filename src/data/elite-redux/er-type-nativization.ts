...
export const ER_TYPE_NATIVIZATION: readonly TypeNativizationEntry[] = [
  ...
  { species: "SPECIES_SELENUMBRA", grant: ErAbilityId.PHANTOM, grantedType: PokemonType.GHOST, replacement: AbilityId.SERENE_GRACE, extraSwap: { from: AbilityId.LEVITATE, to: ER_SPECTACLE_ABILITY_ID }, note: "Also swaps Levitate -> Spectacle (NEW)." },
  ...
  { species: "SPECIES_VOLCARONA_REDUX", grant: ErAbilityId.PHANTOM, grantedType: PokemonType.GHOST, replacement: AbilityId.FLAME_BODY, needsMaintainerEntry: true, note: "Volcarona line." },
