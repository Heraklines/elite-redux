...
export const DEV_SCENARIOS: DevScenario[] = [
  ...
  },
  {
    ...
    description:
      ...
      + "#422-fix - past wave 100, ghost teams are FULLY EVOLVED (a deep team\n"
      + "drawn for a high wave is re-levelled down, never devolved). Only the\n"
      + "EARLY ghost waves (<100) still devolve a too-deep team for fairness.\n"
      + "CHECK: in a Ghost Trainers run, ghosts at wave 137/163/192 show final\n"
      + "evolved forms, NOT babies/base forms (the wave-140 unevolved bug).\n"
