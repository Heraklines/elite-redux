...
export class GameOverPhase extends BattlePhase {
  ...
  start() {
    ...
    // Staging-only player telemetry: this is now a genuine terminal (the ME recovery guard above did not resume it).
    // Showdown returned before this point, and production builds leave telemetry disabled.
