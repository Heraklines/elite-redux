...
let legacyGame: Phaser.Game | null = null;
...
async function startGame(): Promise<void> {
  ...
  legacyGame = new Phaser.Game(gameConfig);
  legacyGame.sound.pauseOnBlur = false;
}
...
export function disposeLegacyTransitionV1(): void {
  legacyGame?.destroy(true);
  legacyGame = null;
}
