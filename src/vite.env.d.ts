...
interface ImportMetaEnv {
  ...
  // prod enablement is a one-line flag flip. `VITE_SERVER_URL_PLAYER_TELEMETRY` overrides the ingest host
  // (else the save-API host `VITE_SERVER_URL`); `VITE_TELEMETRY_SALT` salts the player-id hash. The
  // similarly named VITE_SERVER_URL_TELEMETRY belongs to Showdown/tournament telemetry.
