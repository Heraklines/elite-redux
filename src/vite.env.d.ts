...
interface ImportMetaEnv {
  ...
  // set (deployed builds identify their environment); unset = off (local).
  // `VITE_SERVER_URL_PLAYER_TELEMETRY` overrides the ingest host
  // (else the save-API host `VITE_SERVER_URL`); `VITE_TELEMETRY_SALT` salts the player-id hash. The
  // similarly named VITE_SERVER_URL_TELEMETRY belongs to Showdown/tournament control-plane telemetry.
