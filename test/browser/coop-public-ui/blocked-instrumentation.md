...
| Fresh accounts enter gender selection instead of Title | Provision outside the browser, then choose gender through visible public UI; tutorials use the beta build flag | Account-fixture lifecycle cleanup plus a public onboarding-complete marker |
