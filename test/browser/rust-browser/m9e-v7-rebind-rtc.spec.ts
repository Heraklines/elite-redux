...
test("current V7 Workers physically reconnect RTC generation two and replay continued natural gameplay", async ({ page }, testInfo) => {
  ...
  await testInfo.attach("m9e-current-browser-physical-rebind", { body: report, contentType: "application/json" });
});
